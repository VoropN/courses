...
class NewItemComponent {
  @ViewChild(NewDateDetectorDirective, {static: false}) public directive: NewDateDetectorDirective;
...
describe('NewDateDetectorDirective', () => {
  ...
  it('should show item as new', () => {
    const item = fixture.debugElement.query(By.directive(NewDateDetectorDirective));
